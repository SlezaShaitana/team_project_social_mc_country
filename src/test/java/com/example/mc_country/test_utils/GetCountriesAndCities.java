...
public abstract class GetCountriesAndCities {
    ...
    public void setUp(){
        ...
        countries.add(new CountryDto(UUID.fromString(countryOneId),
                true,
                "Country " + countryOneId,
                List.of("City " + cityOneId, "City " + cityTwoId)
        ));
        countries.add(new CountryDto(
                UUID.fromString(countryTwoId),
                true,
        ...
        cities.add(new CityDto(UUID.fromString(cityOneId), true,
                "City " + cityOneId, UUID.fromString(countryOneId)));
        cities.add(new CityDto(UUID.fromString(cityTwoId), true,
                "City " + cityTwoId, UUID.fromString(countryOneId)));
    }
}
